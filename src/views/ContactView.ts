          ...
          <div class="contact-info reveal-left">
            ...
            <div class="contact-items">
              ${[
                ...
                { icon: '<path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/>',                                                                                                                                                                                                                                                           lbl: 'Email',    val: 'hola@nexaband.es' },
                { icon: '<path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/>',                                                                                                                                                                                                                                                                                                 lbl: 'Sede',     val: 'Madrid, España' },
              ].map(c => `
