"use strict";(()=>{var d=class{constructor(){this.events=new Map}on(e,t){this.events.has(e)||this.events.set(e,new Set),this.events.get(e).add(t)}off(e,t){this.events.get(e)?.delete(t)}emit(e){this.events.get(e)?.forEach(t=>t())}},m=class o extends d{constructor(){super(...arguments);this.state={isScrolled:!1,menuOpen:!1,activeSection:"inicio"}}static getInstance(){return o.instance||(o.instance=new o),o.instance}setScrolled(t){this.state.isScrolled!==t&&(this.state.isScrolled=t,this.emit("scroll"))}toggleMenu(){this.state.menuOpen=!this.state.menuOpen,this.emit("menu")}closeMenu(){this.state.menuOpen&&(this.state.menuOpen=!1,this.emit("menu"))}setActiveSection(t){this.state.activeSection!==t&&(this.state.activeSection=t,this.emit("section"))}};var h=class extends d{constructor(){super(...arguments);this.data={name:"",email:"",phone:"",message:""};this.status="idle";this.errors={}}update(t,i){this.data[t]=i,this.errors[t]&&(delete this.errors[t],this.emit("change"))}validate(){return this.errors={},this.data.name.trim()||(this.errors.name="El nombre es obligatorio."),this.data.email.trim()?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(this.data.email)||(this.errors.email="Email inv\xE1lido."):this.errors.email="El email es obligatorio.",this.data.message.trim()||(this.errors.message="El mensaje es obligatorio."),this.emit("change"),Object.keys(this.errors).length===0}async submit(){this.validate()&&(this.status="sending",this.emit("status"),await new Promise(t=>setTimeout(t,2e3)),this.status="sent",this.emit("status"))}};var P=/^NEXA-[A-Z0-9]{6,10}$/i,u=class extends d{constructor(){super(...arguments);this.id="";this.status="idle";this.error=""}setId(t){this.id=t.toUpperCase(),this.error="",this.emit("change")}validate(){return this.id.trim()?P.test(this.id.trim())?!0:(this.error="Formato inv\xE1lido. Ejemplo: NEXA-ABC123456",this.emit("change"),!1):(this.error="Por favor, introduce tu ID de dispositivo.",this.emit("change"),!1)}async activate(){this.validate()&&(this.status="validating",this.error="",this.emit("status"),await new Promise(t=>setTimeout(t,2e3)),this.status="success",this.emit("status"))}reset(){this.id="",this.status="idle",this.error="",this.emit("status"),this.emit("change")}};var r=class{el(e,t){let i=document.createElement(e);return t&&(i.className=t),i}html(e,t,i){let a=document.createElement(e);return i&&(a.className=i),a.innerHTML=t,a}svgIcon(e,t=24){let i=document.createElementNS("http://www.w3.org/2000/svg","svg");return i.setAttribute("width",String(t)),i.setAttribute("height",String(t)),i.setAttribute("viewBox","0 0 24 24"),i.setAttribute("fill","none"),i.setAttribute("stroke","currentColor"),i.setAttribute("stroke-width","1.5"),i.setAttribute("stroke-linecap","round"),i.setAttribute("stroke-linejoin","round"),i.innerHTML=e,i}getContainer(){return this.container}};var F=[{label:"Inicio",href:"#inicio"},{label:"Producto",href:"#solucion"},{label:"C\xF3mo funciona",href:"#como-funciona"},{label:"Beneficios",href:"#beneficios"},{label:"Planes",href:"#plan"},{label:"Contacto",href:"#contacto"}],g=class extends r{render(){let e=this.el("header","nav-header");return e.innerHTML=`
    ...
    `,this.container=e,e}getForm(){return this.container.querySelector("#contact-form")}getSubmitBtn(){return this.container.querySelector("#form-submit")}showFieldError(e,t){let i=this.container.querySelector(`#err-${e}`);if(!i)return;let a=i.querySelector("span");a.textContent=t,i.style.display="flex"}clearErrors(){this.container.querySelectorAll(".input-error").forEach(e=>e.style.display="none")}setSending(e){let t=this.getSubmitBtn();t.disabled=e,t.innerHTML=e?`${ae} Enviando\u2026`:"Enviar mensaje"}showSuccess(){let e=this.container.querySelector("#contact-form"),t=this.container.querySelector("#form-success");e.style.display="none",t.style.display="flex"}};var C=class{constructor(e,t,i,a){this.model=e;this.headerView=t;this.footerView=i;this.smoothScroll=a}init(){this.bindScroll(),this.bindBurger(),this.bindNavLinks(this.headerView.getNavLinks()),this.bindNavLinks(this.footerView.getNavLinks()),this.bindModelEvents()}bindScroll(){window.addEventListener("scroll",()=>{this.model.setScrolled(window.scrollY>20)},{passive:!0})}bindBurger(){this.headerView.getBurger().addEventListener("click",()=>{this.model.toggleMenu()})}bindNavLinks(e){e.forEach(t=>{t.addEventListener("click",i=>{i.preventDefault();let a=t.getAttribute("href");if(a?.startsWith("#")){let s=document.querySelector(a);s&&this.smoothScroll.scrollToEl(s),this.model.closeMenu()}})})}bindModelEvents(){this.model.on("scroll",()=>{this.headerView.setScrolled(this.model.state.isScrolled)}),this.model.on("menu",()=>{this.headerView.setMenuOpen(this.model.state.menuOpen)})}};var $=class{constructor(){this.y=0;this.targetY=0;this.ease=.085;this.active=!1}init(){if(this.y=this.targetY=window.scrollY,window.matchMedia("(pointer: coarse)").matches)return;this.active=!0;let e=0,t=()=>Array.from(document.querySelectorAll(".hero-section, .section")).map(a=>a.offsetTop).sort((a,s)=>a-s);window.addEventListener("wheel",a=>{a.preventDefault(),clearTimeout(e),this.targetY=this.clamp(this.targetY+a.deltaY),e=window.setTimeout(()=>{let s=t().reduce((n,l)=>Math.abs(l-this.targetY)<Math.abs(n-this.targetY)?l:n);Math.abs(s-this.targetY)<window.innerHeight*.45&&(this.targetY=this.clamp(s))},120)},{passive:!1});let i=()=>{let a=this.targetY-this.y;Math.abs(a)>.1&&(this.y+=a*this.ease,window.scrollTo(0,this.y)),requestAnimationFrame(i)};requestAnimationFrame(i)}scrollToEl(e){this.targetY=this.clamp(e.offsetTop),this.active||e.scrollIntoView({behavior:"smooth"})}clamp(e){return Math.max(0,Math.min(e,document.documentElement.scrollHeight-window.innerHeight))}};var z=["#00E5C3","#00CFFF","#00FFD5","rgba(0,207,255,0.6)"],H=class{constructor(e){this.canvas=e;this.particles=[];this.animId=0;this.loop=()=>{let{ctx:e,canvas:t,particles:i}=this;e.clearRect(0,0,t.width,t.height);for(let a=0;a<i.length;a++){let s=i[a];s.x+=s.vx,s.y+=s.vy,(s.x<0||s.x>t.width)&&(s.vx*=-1),(s.y<0||s.y>t.height)&&(s.vy*=-1),e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fillStyle=s.color,e.globalAlpha=s.alpha,e.fill();for(let n=a+1;n<i.length;n++){let l=i[n],c=s.x-l.x,p=s.y-l.y,v=Math.sqrt(c*c+p*p);v<120&&(e.beginPath(),e.moveTo(s.x,s.y),e.lineTo(l.x,l.y),e.strokeStyle="#00E5C3",e.globalAlpha=(1-v/120)*.12,e.lineWidth=.5,e.stroke())}}e.globalAlpha=1,this.animId=requestAnimationFrame(this.loop)};this.ctx=e.getContext("2d")}init(){this.resize(),window.addEventListener("resize",()=>this.resize(),{passive:!0});for(let e=0;e<120;e++)this.particles.push(this.spawn());this.loop()}destroy(){cancelAnimationFrame(this.animId)}resize(){this.canvas.width=this.canvas.offsetWidth,this.canvas.height=this.canvas.offsetHeight}spawn(){return{x:Math.random()*this.canvas.width,y:Math.random()*this.canvas.height,vx:(Math.random()-.5)*.4,vy:(Math.random()-.5)*.4,r:Math.random()*2+.5,alpha:Math.random()*.6+.2,color:z[Math.floor(Math.random()*z.length)]}}};var V=class{constructor(){this.observer=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&(t.target.classList.add("visible"),this.observer.unobserve(t.target))})},{threshold:.08,rootMargin:"0px 0px -50px 0px"})}observe(){document.querySelectorAll(".reveal, .reveal-left, .reveal-right").forEach(e=>this.observer.observe(e))}};var I=class{constructor(){this.observer=new IntersectionObserver(e=>{e.forEach(t=>{if(t.isIntersecting){let i=t.target,a=parseFloat(i.dataset.counter??"0"),s=i.dataset.suffix??"";this.animate(i,a,s),this.observer.unobserve(i)}})},{threshold:.5})}observe(){document.querySelectorAll("[data-counter]").forEach(e=>this.observer.observe(e))}animate(e,t,i){let s=Date.now(),n=()=>{let l=Date.now()-s,c=Math.min(l/1800,1),p=1-Math.pow(1-c,3),v=t*p;e.textContent=(Number.isInteger(t)?Math.round(v):parseFloat(v.toFixed(1)))+i,c<1&&requestAnimationFrame(n)};requestAnimationFrame(n)}};var N=class{constructor(e,t){this.model=e;this.view=t}init(){let e=this.view.getForm();e.addEventListener("submit",async t=>{t.preventDefault(),this.view.clearErrors();let i=new FormData(e);if(this.model.update("name",String(i.get("name")??"")),this.model.update("email",String(i.get("email")??"")),this.model.update("phone",String(i.get("phone")??"")),this.model.update("message",String(i.get("message")??"")),!this.model.validate()){this.model.errors.name&&this.view.showFieldError("name",this.model.errors.name),this.model.errors.email&&this.view.showFieldError("email",this.model.errors.email),this.model.errors.message&&this.view.showFieldError("msg",this.model.errors.message);return}this.view.setSending(!0),await this.model.submit(),this.view.setSending(!1),this.model.status==="sent"&&this.view.showSuccess()})}};var B=class{constructor(e,t){this.model=e;this.view=t}init(){let e=this.view.getInput(),t=this.view.getSubmitBtn(),i=this.view.getResetBtn();e.addEventListener("input",()=>{this.model.setId(e.value),e.value=this.model.id,this.view.clearError()}),e.addEventListener("keydown",a=>{a.key==="Enter"&&t.click()}),t.addEventListener("click",async()=>{if(this.view.clearError(),!this.model.validate()){this.view.showError(this.model.error);return}this.view.setValidating(!0),await this.model.activate(),this.view.setValidating(!1),this.model.status==="success"&&this.view.showSuccess(this.model.id)}),i.addEventListener("click",()=>{this.model.reset(),this.view.reset()})}};var oe=()=>{let o=document.createElement("div");return o.className="section-divider",o},q=class{constructor(){this.appModel=m.getInstance();this.formModel=new h;this.deviceModel=new u;this.headerView=new g;this.heroView=new f;this.problemView=new w;this.solutionView=new y;this.howItWorksView=new x;this.ecosystemView=new M;this.benefitsView=new E;this.planView=new L;this.socialImpactView=new S;this.valuesView=new k;this.activateDeviceView=new T;this.contactView=new A;this.footerView=new b}init(){let e=document.getElementById("app");if(!e)throw new Error("#app element not found");e.appendChild(this.headerView.render());let t=document.createElement("main"),i=[this.heroView,this.problemView,this.solutionView,this.howItWorksView,this.ecosystemView,this.benefitsView,this.planView,this.socialImpactView,this.valuesView,this.activateDeviceView,this.contactView];i.forEach((n,l)=>{t.appendChild(n.render()),l<i.length-1&&t.appendChild(oe())}),e.appendChild(t),e.appendChild(this.footerView.render());let a=new $;a.init(),this.heroView.getScrollButtons().forEach(n=>{n.addEventListener("click",()=>{let l=n.dataset.scroll,c=l?document.querySelector(l):null;c&&a.scrollToEl(c)})}),this.planView.getCTA()?.addEventListener("click",()=>{let n=document.querySelector("#contacto");n&&a.scrollToEl(n)}),new C(this.appModel,this.headerView,this.footerView,a).init(),new V().observe(),new I().observe(),new N(this.formModel,this.contactView).init(),new B(this.deviceModel,this.activateDeviceView).init(),requestAnimationFrame(()=>{let n=this.heroView.getCanvas();n&&new H(n).init()})}};document.addEventListener("DOMContentLoaded",()=>{new q().init()});})();
